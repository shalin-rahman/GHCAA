...
public class GamificationServiceTests : TestBase
{
    ...
    public async Task AwardPointsAsync_WithValidConfig_ShouldIncreaseMemberPoints()
    {
        ...
        _activityMock.Verify(x => x.LogActivityAsync(member.Id, "PointsAwarded", It.IsContains("50 pts"), It.IsAny<int?>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
    }
