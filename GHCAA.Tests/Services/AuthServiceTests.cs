...
namespace GHCAA.Tests.Services
{
    ...
    public class AuthServiceTests : TestBase
    {
        ...
        public async Task LoginAsync_WithWrongPassword_ShouldReturnNull()
        {
            ...
            var member = new Member { FullName = "Active Member", Status = Enums.MembershipStatus.Active, GHCLastCertificatePassingYear = 2007, Email = "test2@e.com", NID = "124", FatherName="F", MotherName="M", MobileNo="01a", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="P", Designation="D" };
            await _context.Members.AddAsync(member);
            await _context.SaveChangesAsync();
        ...
        public async Task LoginAsync_WithInactiveUser_ShouldReturnNull()
        {
            ...
            var member = new Member { FullName = "Active Member", Status = Enums.MembershipStatus.Active, GHCLastCertificatePassingYear = 2007, Email = "test3@e.com", NID = "125", FatherName="F", MotherName="M", MobileNo="01b", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="P", Designation="D" };
            await _context.Members.AddAsync(member);
            await _context.SaveChangesAsync();
