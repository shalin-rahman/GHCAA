...
namespace GHCAA.Tests.Services
{
    ...
    public class UserServiceTests : TestBase
    {
        ...
        {
            var member1 = new Member { FullName = "Test Member 1", Email = "test1un@e.com", NID = "UN1", MobileNo = "UN1", FatherName="F", MotherName="M", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="I", Designation="D" };
            var member2 = new Member { FullName = "Test Member 2", Email = "test2un@e.com", NID = "UN2", MobileNo = "UN2", FatherName="F", MotherName="M", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="I", Designation="D" };
        ...
        {
            var member = new Member { FullName = "BCrypt Test", Email = "bcrypt@e.com", NID = "BCRYPT1", MobileNo = "BCRYPT1", FatherName="F", MotherName="M", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="I", Designation="D" };
            await _context.Members.AddAsync(member);
            await _context.SaveChangesAsync();
        ...
        {
            var member = new Member { FullName = "Test Member", Email = "cp1@e.com", NID = "CP1", MobileNo = "CP1", FatherName="F", MotherName="M", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="I", Designation="D" };
            await _context.Members.AddAsync(member);
            await _context.SaveChangesAsync();
        ...
        {
            var member = new Member { FullName = "Test Member", Email = "cp2@e.com", NID = "CP2", MobileNo = "CP2", FatherName="F", MotherName="M", PresentAddress="A", PermanentAddress="A", EmergencyContactName="E", EmergencyContactRelation="R", EmergencyContactPhone="0", SubjectGroup="S", ProfessionalSector="I", Designation="D" };
            await _context.Members.AddAsync(member);
            await _context.SaveChangesAsync();
