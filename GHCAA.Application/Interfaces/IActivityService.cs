...
namespace GHCAA.Application.Interfaces
{
    ...
    {
        Task LogActivityAsync(int? memberId, string type, string description, int? actorId = null, string? ipAddress = null, string? userAgent = null, string? source = null, string? metadata = null, CancellationToken cancellationToken = default);
