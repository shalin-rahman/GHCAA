  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      ...
      child: AsyncValueWidget<ForumTopic?>(
        ...
        data: (topic) {
          if (topic == null) {
            return const Center(child: Text('Topic not found.', style: TextStyle(color: Colors.white54)));
          }

          final canDeleteTopic = myMemberId != null && topic.authorId == myMemberId || isAdmin;
            ...
            children: [
              Expanded(
                child: AsyncValueWidget<List<ForumPost>>(
                  ...
                  onRetry: () => ref.invalidate(topicPostsProvider(widget.topicId)),
                  data: (posts) {
                    return RefreshIndicator(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: AppTheme.midnightSurface.withValues(alpha: 0.5),
                                      ...
                                      children: [
                                        CircleAvatar(
                                          ...
                                          child: topic.authorPhotoUrl == null || topic.authorPhotoUrl!.isEmpty
                                              ? const Icon(Icons.person, color: AppTheme.royalGold, size: 18)
                                              : null,
                                        ),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Posted on ${AppUtils.formatDate(topic.createdAt)}',
                          ...
                          final canDeletePost = myMemberId != null && post.authorId == myMemberId || isAdmin;
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      CircleAvatar(
                                        ...
                                        child: post.authorPhotoUrl == null || post.authorPhotoUrl!.isEmpty
                                            ? const Icon(Icons.person, color: AppTheme.royalGold, size: 12)
                                            : null,
                                      ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              AppUtils.formatDate(post.createdAt),
                                      ...
                                      // Reply icon
                                      IconButton(
                                        icon: const Icon(Icons.reply_outlined, color: AppTheme.royalGold, size: 16),
                                        onPressed: () {
                                          HapticFeedback.lightImpact();
                                          setState(() {
                                  ...
                                  if (post.parentPostId != null) ...[
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.subdirectory_arrow_right_rounded, size: 12, color: AppTheme.royalGold),
          ...
          children: [
            if (_replyingToPost != null)
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.reply, size: 14, color: AppTheme.royalGold),
                    const SizedBox(width: 6),
                    Expanded(
                      child: Text(
                        'Replying to ${_replyingToPost!.authorName}',
                        style: const TextStyle(color: AppTheme.textSecondaryDark, fontSize: 10.5, fontWeight: FontWeight.bold),
                      ),
                    ),
                    GestureDetector(
                      onTap: () {
