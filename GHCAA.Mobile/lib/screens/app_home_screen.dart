...
class _AppHomeScreenState extends ConsumerState<AppHomeScreen> {
  ...
  Future<void> _checkBiometrics() async {
    final hasBio =
        await ref.read(biometricServiceProvider).isBiometricsAvailable();
  ...
  Future<void> _handleBiometricLogin() async {
    final reason =
        AppLocalizations.of(context).translate('biometric_unlock_prompt');
    final success =
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      final error =
          await ref.read(authServiceProvider).login(identifier, password);
      if (!mounted) return;
              ...
              children: [
                  ...
                  child: const Hero(
                    ...
                    child: SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: OrgLogo(fit: BoxFit.contain),
                      ),
                    ),
                  )
                      .animate()
                ...
                GlassContainer(
                  child: Column(
                    ...
                    .animate()
                    .slideY(
                        begin: 0.2, duration: 800.ms, curve: Curves.easeOutCirc)
                    .fadeIn(delay: 600.ms),
                const SizedBox(height: AppTheme.spaceL),
                Center(
                  child: Column(
                    children: [
                      TextButton(
                        ...
                        child: Text(
                            '${AppLocalizations.of(context).translate('register').toUpperCase()} HERE',
                            style: const TextStyle(
                                color: AppTheme.royalGold,
                                fontSize: 11,
                                fontWeight: FontWeight.w900,
