...
// --- FAKES ---
// This file's dropdown/assistant fixtures differ from the other
// visual-freeze files' (empty options list, different assistant reply), so
// they stay local rather than moving into helpers/fake_services.dart.
...
void main() {
  ...
  group('Mobile Full-App Visual Freeze', () {
    testGoldens('Auth: Login Portal', (tester) async {
      ...
      await screenMatchesGolden(tester, 'login_portal', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Auth: Registration Wizard', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'registration_wizard', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Member: Governance Portal', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'governance_portal', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Member: Committee Registry', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'committee_registry', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Directory: Member Listing', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'directory_listing', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Events: Event Listing', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'events_listing', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('News: News Portal', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'news_portal', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Financials: Payment Portal', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'financial_portal', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Member: Dashboard Overview', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'dashboard_overview', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Member: Dashboard Overview (Tablet)', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'dashboard_overview_tablet', customPump: pumpAndSettleShort);
    });
    ...
    testGoldens('Member: Digital ID Pass', (tester) async {
      ...
      await pumpAndSettleShort(tester);
      await screenMatchesGolden(tester, 'digital_id_pass', customPump: pumpAndSettleShort);
    });
  });
}
