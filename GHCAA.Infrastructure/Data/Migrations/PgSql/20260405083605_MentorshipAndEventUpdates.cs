        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MentorshipRequests_Members_MentorId",
                        column: x => x.MentorId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MentorshipRequests_Members_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsCollaborators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsCollaborators_NewsPosts_NewsPostId",
                        column: x => x.NewsPostId,
                        principalTable: "NewsPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsCollaborators_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AmendmentVotes_Constitutions_ConstitutionId",
                        column: x => x.ConstitutionId,
                        principalTable: "Constitutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmendmentVotes_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmendmentVotes_ConstitutionId_MemberId",
                table: "AmendmentVotes",
                columns: new[] { "ConstitutionId", "MemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AmendmentVotes_MemberId",
                table: "AmendmentVotes",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsCollaborators_UserId",
                table: "NewsCollaborators",
                column: "UserId");
        }
