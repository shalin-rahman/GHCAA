...
namespace GHCAA.Infrastructure.Data.Migrations.PgSql
{
    ...
    public partial class AddOrganizationConfig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"CREATE TABLE IF NOT EXISTS ""OrganizationConfigs"" (
                ""Id"" integer GENERATED BY DEFAULT AS IDENTITY,
                ""OrgId"" character varying(50) NOT NULL,
                ""SchemaVersion"" integer NOT NULL,
                ""ConfigJson"" text NOT NULL,
                ""UpdatedAt"" timestamp with time zone NOT NULL,
                ""UpdatedByAdminId"" character varying(50),
                CONSTRAINT ""PK_OrganizationConfigs"" PRIMARY KEY (""Id"")
            );");
            ...
            migrationBuilder.Sql(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_OrganizationConfigs_OrgId"" ON ""OrganizationConfigs"" (""OrgId"");");
        }
