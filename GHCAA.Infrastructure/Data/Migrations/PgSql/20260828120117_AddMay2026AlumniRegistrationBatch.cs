    ...
    public partial class AddMay2026AlumniRegistrationBatch : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "integer", "timestamp with time zone", "integer", "timestamp with time zone", "integer", "integer", "text", "integer", "timestamp with time zone", "text", "text", "boolean", "text", "text", "text", "text", "character varying(200)", "timestamp with time zone", "integer", "boolean", "boolean", "boolean", "boolean", "boolean", "boolean", "boolean", "boolean", "boolean", "boolean", "timestamp with time zone", "text", "text", "integer", "text", "text", "text", "boolean", "boolean", "boolean", "boolean", "text", "text", "text", "text", "text", "integer", "text" },
                values: new object[,]
                {
