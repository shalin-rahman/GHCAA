...
namespace GHCAA.Infrastructure.Data.Migrations.PgSql
{
    ...
    public partial class AddSocialAuthConfig : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"CREATE TABLE IF NOT EXISTS ""SocialAuthConfigs"" (
                ""Id"" integer GENERATED BY DEFAULT AS IDENTITY,
                ""Provider"" integer NOT NULL,
                ""ClientId"" character varying(500) NOT NULL,
                ""ClientSecret"" character varying(500),
                ""IsEnabled"" boolean NOT NULL,
                ""CreatedAt"" timestamp with time zone NOT NULL,
                ""UpdatedAt"" timestamp with time zone,
                CONSTRAINT ""PK_SocialAuthConfigs"" PRIMARY KEY (""Id"")
            );");
            ...
            migrationBuilder.Sql(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_SocialAuthConfigs_Provider"" ON ""SocialAuthConfigs"" (""Provider"");");
        }
