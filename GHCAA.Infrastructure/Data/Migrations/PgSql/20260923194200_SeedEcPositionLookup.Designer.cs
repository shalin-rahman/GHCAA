...
namespace GHCAA.Infrastructure.Data.Migrations.PgSql
{
    ...
    [Migration("20260923194200_SeedEcPositionLookup")]
    partial class SeedEcPositionLookup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GHCAA.Domain.Models.SeatVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ElectionSeatId");

                    b.HasIndex("ElectionId", "ElectionSeatId", "MemberId")
                        .IsUnique();
            ...
            modelBuilder.Entity("GHCAA.Domain.Models.SeatVote", b =>
                {
                    ...
                    b.HasOne("GHCAA.Domain.Models.ElectionSeat", null)
                        .WithMany()
                        .HasForeignKey("ElectionSeatId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
