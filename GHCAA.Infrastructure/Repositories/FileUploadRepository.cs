...
namespace GHCAA.Infrastructure.Repositories
{
    public class FileUploadRepository : IFileUploadRepository
    {
        ...
        public async Task<FileUpload?> GetByFilePathAsync(string filePath, CancellationToken cancellationToken = default)
            => await _db.FileUploads.FirstOrDefaultAsync(f => f.FilePath == filePath, cancellationToken);
