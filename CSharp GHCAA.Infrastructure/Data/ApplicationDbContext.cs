...
namespace GHCAA.Infrastructure.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<GHCAA.Domain.Models.FileUpload> FileUploads { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Indexes for FileUpload and PaymentHistory
            modelBuilder.Entity<GHCAA.Domain.Models.FileUpload>()
                .HasIndex(f => new { f.MemberId, f.UploadType });
            modelBuilder.Entity<GHCAA.Domain.Models.PaymentHistory>()
            ...
            modelBuilder.Entity<GHCAA.Domain.Models.FileUpload>().Property(f => f.FileName).HasMaxLength(260);
        }
    }
}